...
VILBERT_VQAV2=1FOtqA7QY0nitc7aJBf-9eLF9RRYkhxps
mkdir output/old
...
mv output/vilbert_vqav2/model.pt output/old/vilbert_vqav2_model_$(date +"%Y_%m_%d_%I_%M_%p")
gdown --id $VILBERT_VQAV2 --output output/vilbert_vqav2/model.bin
