...
-hidden_size 512 -p_drop 0 -grad_clip 0.5 -data_path "data" \
-out_path "output" -cuda True -bs 512 -ep 30 -skip_training False -num_workers 5
...
-out_path "output" -cuda True -bs 128 -ep 30 -skip_training False -num_workers 5