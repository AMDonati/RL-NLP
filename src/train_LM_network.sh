python src/train/train_LM_network.py -model "ln_lstm" "-num_layers 2 -emb_size 256 \
-hidden_size 512 -p_drop 0 -grad_clip 1 -data_path "data" \
-out_path "output" -cuda True -bs 512 -ep 30 -skip_training False -eval False -num_workers 5
