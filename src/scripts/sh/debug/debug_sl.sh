...
python src/train/launch_train.py -task "policy" -dataset "clevr" -data_path "data" -out_path "output/temp" -emb_size 16 -hidden_size 16 -bs 512 -ep 1 -num_workers 6 -fusion "cat"
echo "-------------------------- train policy on CLEVR - condition_answer  ---------------------------------------------------------------------------------------------------"
 python src/train/launch_train.py -task "policy" -dataset "clevr" -data_path "data" -out_path "output/temp" -emb_size 16 -hidden_size 16 -bs 512 -ep 1 -num_workers 6 -fusion "cat" -condition_answer "after_fusion"
