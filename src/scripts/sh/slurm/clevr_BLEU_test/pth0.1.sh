...
#SBATCH --output=slurm_out/clevr/T-pth-%j.out
#SBATCH --error=slurm_out/clevr/T-pth-%j.err
...
MODEL_PATH="output/RL/CLEVR_BLEU_reward_small/proba_thr0.1"
