...
#SBATCH --output=slurm_out/clevr/T-sample30-%j.out
#SBATCH --error=slurm_out/clevr/T-sample30-%j.err
...
MODEL_PATH="output/RL/CLEVR_BLEU_reward_small/sample_va30"
