#!/bin/bash
#SBATCH --job-name=C-pretrain-tr-pth0.05
...
#SBATCH --output=slurm_out/clevr/pretrain-trunc-pth0.05-%j.out
#SBATCH --error=slurm_out/clevr/pretrain-trunc-pth0.05-%j.err
