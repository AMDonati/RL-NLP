...
#SBATCH --output=slurm_out/clevr/trunc-ext-topp-%j.out
#SBATCH --error=slurm_out/clevr/trunc-ext-topp-%j.err
...
OUTPUT_PATH="output/RL/CLEVR_lm_ext/trunc_policy"
