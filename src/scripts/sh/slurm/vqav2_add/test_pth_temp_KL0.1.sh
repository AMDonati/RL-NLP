...
#SBATCH --output=slurm_out/vqa/T-pth-temp-KL-%j.out
#SBATCH --error=slurm_out/vqa/T-pth-temp-KL-%j.err
...
MODEL_PATH="output/RL/VQA_vilbert_small/proba_thr0.005_temp1.5_tmin1.0_KLdiv0.1"
