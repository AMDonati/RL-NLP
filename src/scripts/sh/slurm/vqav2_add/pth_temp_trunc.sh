#!/bin/bash
#SBATCH --job-name=trunc-pth-temp
#SBATCH --qos=qos_gpu-t4
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=8g
#SBATCH --output=slurm_out/vqa/trunc-pth-temp-%j.out
#SBATCH --error=slurm_out/vqa/trunc-pth-temp-%j.err
...
OUTPUT_PATH="output/RL/VQAv2_add/trunc_policy"
