#!/bin/bash
#SBATCH --job-name=G-pth-temp-KL.5
...
#SBATCH --output=slurm_out/vqa/G-pth-temp-KL.5-%j.out
#SBATCH --error=slurm_out/vqa/G-pth-temp-KL.5-%j.err
